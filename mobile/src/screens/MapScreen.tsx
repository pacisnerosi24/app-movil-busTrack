...
const styles = StyleSheet.create({
  ...
  topRow: { flexDirection: 'column', alignItems: 'flex-start', gap: 8, marginTop: 8 },
  pill: { flexDirection: 'row', alignItems: 'center', gap: 8, maxWidth: '100%', backgroundColor: colors.textDark, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 999 },
  pillDot: { width: 9, height: 9, borderRadius: 5 },
  pillTxt: { color: '#fff', fontWeight: '700', fontSize: 13, flexShrink: 1 },
  segment: { flexDirection: 'row', maxWidth: '100%', backgroundColor: '#fff', borderRadius: 999, padding: 3, gap: 2, shadowColor: '#1B2B4B', shadowOpacity: 0.18, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 5 },
  segBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, flexShrink: 1, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 999 },
  segTxt: { fontWeight: '800', fontSize: 12.5, color: colors.textMutedDark, flexShrink: 1, maxWidth: 130 },
