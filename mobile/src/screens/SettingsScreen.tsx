...
import { persistApiBase, getDefaultApiBase } from '../config';
...
export default function SettingsScreen() {
  ...
  async function handleReset() {
    ...
    setUrl(def);
    await persistApiBase(def);
    updateApiBase(def);
    Alert.alert('Restablecido', `URL restablecida a:\n${def}`);
  }
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.hint}>
            Dirección donde corre el backend. Puede ser una IP local, un túnel ngrok o un dominio.
          </Text>
          ...
          <TouchableOpacity style={styles.resetBtn} onPress={handleReset} activeOpacity={0.7}>
            ...
            <Text style={styles.resetTxt}>Restablecer valor por defecto</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoTxt}>
            ...
            Para IP local en misma red WiFi:{'\n'}
